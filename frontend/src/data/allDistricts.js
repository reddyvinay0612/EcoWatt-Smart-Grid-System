const allDistricts = {
  ...
  "Andhra Pradesh": [
    ...
    "Kadapa", "Parvathipuram Manyam", "Alluri Sitharama Raju", "Anakapalli", "Kakinada", 
    "Kona Seema", "Eluru", "NTR", "Bapatla", "Palnadu", "Nandyal", "Sri Sathya Sai", 
    "Annamayya", "Tirupati"
  ],
  "Arunachal Pradesh": [
  ...
  "Chhattisgarh": [
    ...
    "Dantewada", "Dhamtari", "Gariaband", "Gaurela-Pendra-Marwahi", "Janjgir-Champa", 
    ...
    "Khairagarh-Chhuikhadan-Gandai", "Manendragarh-Chirmiri-Bharatpur", "Sakti"
  ],
  ...
  "Jammu and Kashmir": [
    "Anantnag", "Budgam", "Bandipora", "Baramulla", "Doda", "Ganderbal", "Jammu", 
  ...
  "Mizoram": [
    "Aizawl", "Lunglei", "Champhai", "Lawngtlai", "Mamit", "Saiha", "Serchhip", 
    "Kolasib", "Hnahthial", "Khawzawl", "Saitual"
  ],
  "Nagaland": [
    "Dimapur", "Kiphire", "Kohima", "Longleng", "Mokokchung", "Mon", "Peren", 
    "Phek", "Tuensang", "Wokha", "Zunheboto", "Noklak", "Chumoukedima", "Niuland", 
    "Tseminyu", "Shamator"
  ],
  "Odisha": [
  ...
  "Rajasthan": [
    ...
    "Gangapur City", "Jaipur Rural", "Jodhpur Rural", "Kekri", "Kotputli-Behror", 
    "Khairthal-Tijara", "Neem Ka Thana", "Phalodi", "Salumbar", "Sanchore", "Shahpura"
  ],
  "Sikkim": ["Gangtok", "Namchi", "Geyzing", "Mangan", "Soreng", "Pakyong"],
  "Tamil Nadu": [
  ...
  "Uttar Pradesh": [
    ...
    "Buldhahr", "Bulandshahr", "Chandauli", "Chitrakoot", "Deoria", "Etah", 
    "Etawah", "Ayodhya", "Farrukhabad", "Fatehpur", "Firozabad", "Gautam Buddha Nagar", 
